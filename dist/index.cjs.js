  ...
  return data.filter(function (row) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var val = _step.value;
        colVal = val.format ? (_ReactDOMServer$rende = ReactDOMServer__default['default'].renderToStaticMarkup(val.format(row))) === null || _ReactDOMServer$rende === void 0 ? void 0 : _ReactDOMServer$rende.replace(/<[^>]*>?/gm, '') : (_row$val$key = row[val.key]) === null || _row$val$key === void 0 ? void 0 : _row$val$key.toString();
...
var SimpleTable = function SimpleTable(_ref) {
  ...
  var tableRef = /*#__PURE__*/React.createRef();
  ...
  tableCol.forEach(function (_ref2, i) {
    ...
    colTitle.push( /*#__PURE__*/React__default['default'].createElement("th", {
      key: "th-".concat(i),
    ...
    records[i] = function () {
      ...
      tableCol.forEach(function (_ref3, j) {
        ...
        if (format && typeof format === "function") {
          row.push( /*#__PURE__*/React__default['default'].createElement("td", {
            key: "td-".concat(i).concat(j),
            style: {
              verticalAlign: "middle"
            }
          }, format(_objectSpread2(_objectSpread2({}, tableData[i]), {}, {
            _index: i
          }))));
  ...
  if (table.pg > maxPage) {
    setTable(_objectSpread2(_objectSpread2({}, table), {}, {
      pg: maxPage
    }));
  }
  ...
  items.push( /*#__PURE__*/React__default['default'].createElement("li", {
    className: "page-item",
    key: "pg-0",
    style: {
      marginRight: "0.5rem"
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    ref: tableRef
  }, searchBox ? /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("input", {
    type: "search",
    placeholder: "Search",
    ...
    onInput: function onInput(e) {
      ...
      return setTable(_objectSpread2(_objectSpread2({}, table), {}, {
  ...
  }, /*#__PURE__*/React__default['default'].createElement("tr", null, colTitle)), /*#__PURE__*/React__default['default'].createElement("tbody", null, records.length === 0 ? /*#__PURE__*/React__default['default'].createElement("tr", null, /*#__PURE__*/React__default['default'].createElement("td", {
    className: "text-center p-4",
    colSpan: "9"
  }, "No ", table.query === "" ? "Record" : "Match", " Found")) : records))), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "px-3 row"
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: "col-sm-8"
